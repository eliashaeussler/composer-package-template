...
/**
 * CodeClimateServiceTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
#[Framework\Attributes\CoversClass(Src\Service\CodeClimateService::class)]
final class CodeClimateServiceTest extends Framework\TestCase
{
    ...
    private Src\Service\CodeClimateService $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new Src\Service\CodeClimateService(
    ...
    public function apiRequestsRequireAccessTokenFromUserInput(): void
    {
        ...
        self::assertNull($this->tokenStorage->get(Src\Enums\TokenIdentifier::CodeClimate));
        ...
        self::assertSame('foo', $this->tokenStorage->get(Src\Enums\TokenIdentifier::CodeClimate));
    }
