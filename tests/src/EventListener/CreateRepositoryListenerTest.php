...
/**
 * CreateRepositoryListenerTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
#[Framework\Attributes\CoversClass(Src\EventListener\CreateRepositoryListener::class)]
final class CreateRepositoryListenerTest extends Framework\TestCase
{
    ...
    private Src\EventListener\CreateRepositoryListener $subject;
    ...
    protected function setUp(): void
    {
        ...
        $processFactory = new Src\Resource\ProcessFactory(
        ...
        $this->subject = new Src\EventListener\CreateRepositoryListener(
